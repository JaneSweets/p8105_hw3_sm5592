...
The resulting data set contains `r nrow(excellent_df)` observations and `r ncol(excellent_df)` variables related to the average value of `r excellent_df |> pull(state) |> unique() |> length()` states. To make a “spaghetti” plot, I first divide the states into three categories based on their data in 2002.
